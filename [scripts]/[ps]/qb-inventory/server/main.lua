...
RegisterNetEvent("qb-inventory:server:openPoliceArmoury", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if not Player then return end
    ...
    print("[DEBUG SERVER] Creating police armoury shop")
    ...
    print("[DEBUG SERVER] Opening police armoury shop")
